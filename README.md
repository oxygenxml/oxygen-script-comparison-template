...
📝 If you want to perform comparisons between branches on another repository, you may want to check [Oxygen Comparison action](https://github.com/marketplace/actions/oxygen-xml-json-compare-branches) and include it in your workflow.
